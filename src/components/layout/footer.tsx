        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                <a href={`mailto:${siteConfig.organizer.email}`} className="hover:text-foreground transition-colors">
                  {siteConfig.organizer.email}
                </a>
              </li>
              <li>
                <a href={`tel:${siteConfig.organizer.phone}`} className="hover:text-foreground transition-colors">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-3">{t.footer.info}</h3>
