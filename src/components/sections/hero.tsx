  ...
  return (
    <section className="relative overflow-hidden min-h-svh flex flex-col justify-center" data-section>
      ...
      <div className="absolute inset-0 hero-blur-layer">
        <Image src="/images/hero-bg.png" alt="" fill className="object-cover object-[center_45%]" />
        <div className="absolute inset-0 bg-black/55" />
      </div>
      ...
      <div className="relative container mx-auto px-4 text-center">
        <AnimateOnScroll variant="fade-up" delay={200}>
          <h1 className="text-4xl font-bold tracking-tight text-white md:text-6xl">{siteConfig.name}</h1>
        </AnimateOnScroll>
        <AnimateOnScroll variant="fade-up" delay={400}>
          <p className="mx-auto mt-4 max-w-2xl text-lg text-white/80 md:text-xl">{t.hero.description}</p>
        </AnimateOnScroll>
